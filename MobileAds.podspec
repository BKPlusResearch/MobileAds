...
Pod::Spec.new do |spec|
  ...
  spec.name         = "MobileAds"
  spec.version      = "2.0.0"
  spec.summary      = "Google Mobile Ads + entitlements-first StoreKit 2 IAP for iOS; SwiftUI support, native small/medium templates with shared NativeAdConfiguration theming"
  ...
  **2.0.0 is a breaking release.** The legacy `IAPService` / `IAPViewModel` layer has been removed. `EntitlementService` is now the only IAP layer. Apps on 1.x must migrate; see "Upgrading from 1.x to 2.0" in the README.
...
# spec.resources     = "MobileAds/**/*.{png,jpeg,jpg,storyboard,xib,xcassets,plist}"
  ...
  spec.dependency 'GoogleMobileAdsMediationMintegral', '~> 8.1.3.1'
  spec.dependency 'GoogleMobileAdsMediationPangle', '~> 7.9.1.1.0'
  spec.dependency 'GoogleMobileAdsMediationUnity', '~> 4.18.0.0'
